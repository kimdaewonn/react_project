        ...
        <div className="class__box">
          <div className="class__bar">
            <div className="bar-t">
              ...
              <div className="icon__cont">
                <img src="/assets/donut.png" alt="디저트" />
                <div>디저트</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/bob.png" alt="밥/죽/떡" />
                <div>밥/죽/떡</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/kimchi.png" alt="김치/젓갈류" />
                <div>김치/젓갈류</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/sandwichi.png" alt="샌드위치" />
                <div>샌드위치</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/jungol.png" alt="찌개/전골" />
                <div>찌개/전골</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/salad.png" alt="샐러드" />
                <div>샐러드</div>
              </div>
            </div>
            <div className="bar-b">
              <div className="icon__cont">
                <img src="/assets/steak.png" alt="양식" />
                <div>양식</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/ting.png" alt="튀김" />
                <div>튀김</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/drink.png" alt="차/음료" />
                <div>차/음료</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/fish.png" alt="고기/생선" />
                <div>고기/생선</div>
              </div>
              <div className="icon__cont">
                <img src="/assets/tray.png" alt="기타" />
                <div>기타</div>
              </div>
            </div>
          </div>
